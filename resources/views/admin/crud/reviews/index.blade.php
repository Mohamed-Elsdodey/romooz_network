    ...
    <script>
        ...
        datatable_selector = $('#Datatable').DataTable({
            ...
            "columns": [
                ...
                {"data": "evaluation", orderable: false, searchable: false},
                {"data": "message", orderable: false, searchable: true},
                {"data": "user_name", orderable: false, searchable: true},
                {"data": "app_name", orderable: false, searchable: true},
