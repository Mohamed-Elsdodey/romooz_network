                    ...
                    <div class="row mb-2">
                            <div class="col-sm-4">
                                <div class="text-sm-start">
                                    <a href="" id="addButton" type="button"
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">اعمالنا</h5>
    ...
    <script>
        ...
        $(document).on('click', '.delete', function () {
            ...
            Swal.fire({
                ...
                // console.log(result)
                if (result.value) {
                    var url ="{{route('ourWorks.destroy',':id')}}";
                ...
                Swal.fire({
                    ...
                    if (result.value) {
                        if (id.length > 0) {
                            ...
                            $.ajax({
                                url: "{{route('ourWorks.delete.bulk')}}",
                                type: 'DELETE',
                                data: {id: id},
                                success: function (data) {
                                    $("#bulk_delete").hide()
            ...
            $.ajax({
                ...
                success: function(data){
                    window.setTimeout(function() {
                        ...
                        $('#exampleModalLabel').html('اضافة عمل جديد')
...
<script>
    $(document).on('click','.editButton',function (e) {
        ...
        var url = '{{route('ourWorks.edit',":id")}}';
        url = url.replace(':id', id);
        ...
        $.ajax({
            ...
            success: function(data){
                window.setTimeout(function() {
                    ...
                    $('#form-for-addOrDelete').html(data.html);
                    $('.loader-ajax').hide()
                    $('#exampleModalLabel').html('تعديل العمل')
                    $('#exampleModalCenter').modal('show')
                    $('.dropify').dropify()
                    $('[data-toggle="tooltip"]').tooltip()
                    $.validate({
