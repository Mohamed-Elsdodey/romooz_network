...
{{--                            </div>--}}
                           {{------------------}}
                            <div class="tab-pane fade" id="v-pills-step" role="tabpanel"
                                 aria-labelledby="v-pills-step-ta">
                                @include("admin.settings.parts.header")
                            </div>
...
@section('js')
    ...
    <script>
        ...
        $(document).on('submit', 'form#Form_header', function (e) {
            e.preventDefault();
            var myForm = $("#Form_header")[0]
            var formData = new FormData(myForm)
            var url = $('#Form_header').attr('action');
            sendAjax(url, formData);
        });
