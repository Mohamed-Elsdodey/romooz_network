...
class AdminTypeController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('admin.crud.types.index');
    }
    ...
    {
        if ($request->ajax()) {
            $returnHTML = view("admin.crud.types.parts.add_form")->with([
    ...
    {
        if ($request->ajax()) {
            $returnHTML = view("admin.crud.types.parts.edit_form")
                ->with([
    ...
    {
        return response()->json(Type::destroy($id), 200);
    }
